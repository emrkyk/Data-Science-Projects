...
binary_cols = [col for col in df.columns if df[col].dtypes == 'O']  # kategorik ve 2 sınıflı değişkenleri seç
# ['NEW_BP']
...
y_prob = cart_model.predict_proba(X)[:, 1]  # <= 1. sınıfa ait olma olasılıkları
